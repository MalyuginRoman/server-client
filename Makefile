all:
	...
	g++ -std=c++17 middleware.cpp eventloop.cpp exceptionhandler.cpp game_creator.cpp game_server.cpp icommand.cpp istate.cpp minor.cpp movecommand.cpp object.cpp objposition.cpp order.cpp scope.cpp start_game.cpp -o middleware1
